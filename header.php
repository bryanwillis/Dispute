...
<head>
	...
	<?php wp_head(); ?>
</head><meta name="msvalidate.01" content="71146C7AC3640139E52F7EA764DAD962" />
             ...
             <div class="col-md-12 top-p ">
                ...
                <div class="nav col-md-9 col-sm-10 col-xs-7">
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul class="top-ul">
                            <li><a id="menu-what" href="javascript:void(0)" onclick="scroll_to_page('what')">What</a></li>                          
                            <li><a id="menu-works" href="javascript:void(0)" onclick="scroll_to_page('works')">How it works</a></li>
                            <li><a id="menu-who" href="javascript:void(0)" onclick="scroll_to_page('who')">Who</a></li>
                            <li><a id="menu-why" href="javascript:void(0)" onclick="scroll_to_page('why')">Why</a></li>
                            <li><a id="menu-pricing" href="javascript:void(0)" onclick="scroll_to_page('pricing')">Pricing Options</a></li>  
                            <li><a id="menu-contact" href="javascript:void(0)" onclick="scroll_to_page('contact')">Contact</a></li>
